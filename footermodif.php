    ...
    <div class="section_w900">
        ...
        <div class="section_w260 float_l margin_r60">
            ...
            <form method="post">
                    ...
                    while($row = mysql_fetch_assoc($result))
                    {
                        ...
                        <tr>
                            ...
                            <td  align="center">
                                ...
                                <?php $lien = "footermodif2.php?action=modif&ID=".$row["ID"]."&table=Footer"?>
                ...
                <br/>
                <input type="button" name="Ajouter" value="Ajouter une section" onclick="self.location.href='footermodif2.php?action=ajout'"/>
            </form>
