	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var monthNames = options.monthNames || [ 'Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Décembre' ];
					...
					for(var col = 0; col < maxCol; col++, cellIndex++) {
						...
						if(!row) {
							...
							if(!isSelectable ||
								...
								cellClass = ([ 'Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Dim' ])[cellDateVal.day];
