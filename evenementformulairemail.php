...
<div id="templatemo_content">
    ...
    <form action="evenementformulairemail2.php" method="post">
            Nom de l'&eacute;tudiant : <br>
            <input type="text" name="NomEtudiant" size="20"><br><br>
            Nom de concentration du programme (Gestion de r&eacute;seaux informatiques, Informatique Industrielle,
