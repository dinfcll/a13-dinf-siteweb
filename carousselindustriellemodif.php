...
{
    $sql = "SELECT ID, Titre, Donnee from CarousselIndu where ID=".$_GET["ID"];
...
if(isset($_POST['Modifier'])){
    ...
    $sql1 = "update CarousselIndu set ID='".$ID."', Titre='".$Titre."', Donnee='".$Donnee."'";
    if ($_POST['idp'] != "vide"){
...
if(isset($_POST['Insert'])){
    ...
    if ($_POST['idp'] != "vide"){
        $sql1 = "insert into CarousselIndu (`ID`, `Titre`, `Donnee`) values ('".$ID."', '".$Titre."', '".$Donnee."')";
    }
    else{
        $sql1 = "insert into CarousselIndu (`ID`, `Titre`, `Donnee`) values ('".$ID."', '".$Titre."', '".$Donnee."')";
    }
        ...
        <div id="templatemo_content">
            ...
            <div class="section_w900">
                ...
                <div class="section_w260 float_l margin_r60">
                    ...
                    <form method="post" action="update.php?table=CarousselIndu">
